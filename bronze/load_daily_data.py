...
if __name__=='__main__':
    os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r'C:\Users\Lenovo N24\Documents\earthquake_ingestion\prj-project1-441009-830b645c748e.json'
    ...
    if data:
        ...
        bucket_name = "earthquake_analysis_2"
        current_date = datetime.now()
        formatted_date = current_date.strftime('%Y%m%d')
        destination_blob_name =f"pyspark/daily_landing/{formatted_date}/earthquake_raw.json"
